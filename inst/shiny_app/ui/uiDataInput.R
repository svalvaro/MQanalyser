uiDataInput <-  tabPanel(
    ...
    sidebarLayout(
        sidebarPanel(
            ...
            fileInput(
                inputId = 'user_genes',
                label = h4(
                    'Provide a list of desired genes to check
            ...
            tags$a(
                href = 'data/user_genes_examples.txt',
                h5('Genes example'),
                download = NA,
                target = '_blank'
            ),
            tags$a(
                href = 'data/experiment_design_example.txt',
            ...
            fluidRow(
                ...
                column(
                    ...
                    box(
                        ...
                        h5(
                            'Alternatively an experiment design can
    ...
    fluidRow(column(
        ...
        p(
            ...
            tags$a(
                href = "mailto:alvaro.sanchez@fgu.cas.cz",
